...
/*
    void Start()
    {
        // Listen to left and right hand trigger 
        //GrabPinchAction.AddOnStateDownListener(TriggerDown, leftHand);
        //GrabPinchAction.AddOnStateDownListener(TriggerDown, rightHand);
    }
    // Listener for trigger down 
    // Args: Action that sent, Input Source that sent
    public void TriggerDown(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSources)
    {
        Debug.Log("Trigger down");
        Debug.Log(fromSources.ToString());
    }
*/
